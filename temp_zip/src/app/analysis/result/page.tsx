                        ...
                        <div className="patient-info-section">
                            <div className="patient-info-group">
                                ...
                                <div className="patient-info-grid">
                                    <div className="patient-info-item">
                                        ...
                                        <div
                                            className="patient-info-value">{analysisResults.patientInfo.firstName} {analysisResults.patientInfo.lastName}</div>
                                    </div>
                                    <div className="patient-info-item">
                                    ...
                                    <div className="patient-info-item">
                                        ...
                                        <div
                                            className="patient-info-value">{new Date(analysisResults.patientInfo.birthDate).toLocaleDateString('tr-TR')}</div>
                                    </div>
                                    <div className="patient-info-item">
                                        <div className="patient-info-label">Cinsiyet</div>
                                        <div
                                            className="patient-info-value">{analysisResults.patientInfo.gender === 'male' ? 'Erkek' : 'Kadın'}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="patient-info-group">
                                ...
                                <div className="patient-info-grid">
                                    <div className="patient-info-item">
                                        ...
                                        <div className="patient-info-value">{analysisResults.patientInfo.height} cm
                                        </div>
                                    </div>
                                    <div className="patient-info-item">
                                        <div className="patient-info-label">Kilo</div>
                                        <div className="patient-info-value">{analysisResults.patientInfo.weight} kg
                                        </div>
                                    </div>
                                    <div className="patient-info-item">
                                    ...
                                    <div className="patient-info-item">
                                        ...
                                        <div
                                            className="patient-info-value">{analysisResults.patientInfo.bloodType}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="patient-info-group">
                                ...
                                <div className="patient-info-grid">
                                    ...
                                    <div className="patient-info-item full-width">
                                        <div className="patient-info-label">Son 6 Ayda Geçirilen Önemli Hastalıklar
                                        </div>
                                        <div className="patient-info-value">
