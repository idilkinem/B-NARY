    ...
    <main className="min-h-screen relative">
      ...
      <div className="relative z-10 pt-20 pb-10">
        <div className="container mx-auto px-4">
          ...
          {/* Abone Ol Bölümü */}
          <section className="subscribe-section mt-8" data-aos="fade-up">
            <h2 className="subscribe-title">Sağlık Haberlerine Abone Olun</h2>
            <p className="subscribe-description">
              En güncel sağlık haberlerini, uzman görüşlerini ve sağlık ipuçlarını kaçırmak için bültenimize abone olun.
            </p>
            <form onSubmit={handleSubmit} className="subscribe-form">
              ...
              <button 
                type="submit" 
                disabled={isLoading}
                className={`subscribe-button ${isLoading ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
            ...
            <div className="subscribe-benefits">
              <div className="benefit-item">
                ...
                <h3 className="benefit-title">Anlık Bildirimler</h3>
                <p className="benefit-description">Önemli sağlık haberlerini anında alın</p>
              </div>
              <div className="benefit-item">
                <div className="benefit-icon">
                  <i className="fas fa-user-md"></i>
                </div>
                <h3 className="benefit-title">Uzman Görüşleri</h3>
                <p className="benefit-description">Sağlık uzmanlarından özel içerikler</p>
              </div>
              <div className="benefit-item">
                <div className="benefit-icon">
                  <i className="fas fa-heart"></i>
                </div>
                <h3 className="benefit-title">Sağlık İpuçları</h3>
                <p className="benefit-description">Günlük sağlık önerileri ve ipuçları</p>
              </div>
            </div>
          </section>
        </div>
